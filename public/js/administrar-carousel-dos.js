  ...
  let noticias = document.querySelectorAll(".noticias .noticiasItem");
    ...
    for (var i = 0; i < noticias.length; i++){
      ...
      noticiaInputAgregar.onclick = function(){
        ...
        imagenesDisponiblesAhora (imagenesDisponibles.lastElementChild);
      }
    }
...
funcion noticias
pone en fondoGrissaca el checked de la seleccion anterior

modificar funcion imagenes para que no tenga param
  ...
  function imagenesDisponiblesAhora (cajaActiva){
    ...
    for (var i = 0; i < cajaActiva.children.length; i++) {
      ...
      for (var ii = 0; ii < carouselAhora.length; ii++) {
        if (carouselAhora[ii].firstElementChild.nextElementSibling.value == input.value){

          input.setAttribute("disabled", "");
          input.nextElementSibling.style.filter = "grayscale(100%";

        // } else if (carouselAhora[ii].firstElementChild.nextElementSibling.value == input.value && input.checked == true) {
        //
        //   input.nextElementSibling.style.filter = "grayscale(100%";
